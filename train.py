...
# --- Models ---
# Initialize VAE with Tacotron2 decoder
vae = VAE(
    n_mels=80,
    spk_emb_dim=256,
    latent_dim=64,
...
for epoch in range(1, EPOCHS + 1):
    ...
    if epoch % 5 == 0:
        torch.save(
            ...
            os.path.join(CHECKPOINT_DIR, f"vae_tacotron2_epoch{epoch}.pt"),
        )
    ...
    if avg_loss < best_loss:
        ...
        torch.save(
            ...
            os.path.join(CHECKPOINT_DIR, "vae_tacotron2_best.pt"),
        )

print("Training completed!")
print(f"Best loss: {best_loss:.4f}")
print(f"Model saved to: {os.path.join(CHECKPOINT_DIR, 'vae_tacotron2_best.pt')}")
